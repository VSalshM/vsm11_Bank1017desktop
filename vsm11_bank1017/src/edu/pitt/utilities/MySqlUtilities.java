...
public class MySqlUtilities implements DbUtilities{
	...
	private String dbName = "vsm11_bank1017"; // default database name
	private String dbUserName = "vsm11"; // login name for the database server
	private String dbPassword = "3946979"; // password for the database server
